...
{
    internal class SaveRaceDataDelegate : DataDelegate
    {
        ...
        public SaveRaceDataDelegate(int classID, string name, string description, int defenseMod, int attackMod) : base("Race.SaveRaces")
        {
            _classID = classID;
            _name = name;
